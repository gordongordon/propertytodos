          ...
          <AppBar title="Y Match X" />
           ...
           <BottomNavigationBar/>
                ...
                <div>
                    ...
                    <RaisedButton onClick={() => model.clear()} style={buttonStyle} label="clear" />
                </div>
                <Table>
                    <TableHeader displaySelectAll={false}>
                        <TableRow>
                            ...
                            <TableHeaderColumn>Locaiton</TableHeaderColumn>
...
export class SingleSaleHomeView extends React.Component{
    ...
    render(){
        ...
        return <TableRow striped={property.done} displayBorder={false} showCheckboxes={false}>
                    <TableRowColumn>
                    ...
                    <TableRowColumn>
                        <TextField name="type" type="text" value={property.location} onChange={e => {property.location = e.target.value}} fullWidth={false} />
                    </TableRowColumn>
                    <TableRowColumn>
                        <TextField name="type" type="text" value={property.type} onChange={e => {property.type = e.target.value}} fullWidth={false} />
                    </TableRowColumn>
                    <TableRowColumn>
                    ...
                    <TableRowColumn>
                        <RaisedButton onClick={() => model.saveOne(property)} label="save" />
                    </TableRowColumn>
                </TableRow>
    }
}
