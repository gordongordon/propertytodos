...
@observer
export class TodoLeaseHomeView extends React.Component{
    render(){
        ...
        return <MuiThemeProvider>
            <div>
                ...
                <div>
                    ...
                    <RaisedButton onClick={() => model.save()} style={buttonStyle} label="property" />
...
@observer
export class SingleTodoLeaseHomeView extends React.Component{
    ...
    render(){
        ...
        return <TableRow striped={todo.done} displayBorder={false}>
                    ...
                    <TableRowColumn>
                        <TextField name="price" type="text" value={todo.price} onChange={e => {todo.price = e.target.value}} fullWidth={false} />
                    </TableRowColumn>
                    <TableRowColumn>
